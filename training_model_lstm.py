...
def train(train_dataset_paths, dev_dataset_paths=[], model_path=None, epochs=400, rnn_layers=2, rnn_hidden_size=128, fc_size=128, rnn_dropout=0.4, fc_droupout=0.4,
    ...
    try:
        ...
        model = KeypointClassifierLSTMLightning(device=device, rnn_hidden_size=rnn_hidden_size,
...
def main(timesteps=None):
    ...
    train([r'samples\dataset_cauca_s_train.h5', r'samples\dataset_fifty_ways_s_train.h5'], [
        r'samples\dataset_cauca_s_validation.h5', r'samples\dataset_fifty_ways_s_validation.h5'], model_path="model_lstm.pt",
    ...
    train([r'samples\dataset_cauca_s_train.h5', r'samples\dataset_fifty_ways_s_train.h5'], [
        r'samples\dataset_cauca_s_validation.h5', r'samples\dataset_fifty_ways_s_validation.h5'], model_path="model_lstm.pt",
        from_checkpoint=False, rnn_layers=1, rnn_hidden_size=64, fc_size=64, timesteps=timesteps)

    train([r'samples\dataset_cauca_s_train.h5', r'samples\dataset_fifty_ways_s_train.h5'], [
        r'samples\dataset_cauca_s_validation.h5', r'samples\dataset_fifty_ways_s_validation.h5'], model_path="model_lstm.pt",
        from_checkpoint=False, rnn_hidden_size=256, fc_size=256, timesteps=timesteps)

    train([r'samples\dataset_cauca_s_train.h5', r'samples\dataset_fifty_ways_s_train.h5'], [
        r'samples\dataset_cauca_s_validation.h5', r'samples\dataset_fifty_ways_s_validation.h5'], model_path="model_lstm.pt",
        from_checkpoint=False, rnn_hidden_size=256, fc_size=128, timesteps=timesteps)

    train([r'samples\dataset_cauca_s_train.h5', r'samples\dataset_fifty_ways_s_train.h5'], [
        r'samples\dataset_cauca_s_validation.h5', r'samples\dataset_fifty_ways_s_validation.h5'], model_path="model_lstm.pt",
        from_checkpoint=False, rnn_layers=3, rnn_hidden_size=128, fc_size=64, timesteps=timesteps)

    train([r'samples\dataset_cauca_s_train.h5', r'samples\dataset_fifty_ways_s_train.h5'], [
        r'samples\dataset_cauca_s_validation.h5', r'samples\dataset_fifty_ways_s_validation.h5'], model_path="model_lstm.pt",
        from_checkpoint=False, rnn_layers=3, rnn_hidden_size=256, fc_size=128, timesteps=timesteps)

    train([r'samples\dataset_cauca_s_train.h5', r'samples\dataset_fifty_ways_s_train.h5'], [
        r'samples\dataset_cauca_s_validation.h5', r'samples\dataset_fifty_ways_s_validation.h5'], model_path="model_lstm.pt",
        from_checkpoint=False, rnn_layers=3, rnn_hidden_size=256, fc_size=256, timesteps=timesteps)
