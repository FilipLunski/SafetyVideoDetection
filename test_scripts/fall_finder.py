...
def main(video_folder, out_folder="", input_format="mp4", seconds_before=2, seconds_after=2, threshold=0.5, device="cuda"):
    ...
    for file in files:
        ...
        processFile(file, out_folder, seconds_before=2,
                    seconds_after=2, threshold=threshold, device=device)


def processFile(file, out_folder, seconds_before, seconds_after, threshold, device):
